...
export const useGetImagesQuery = <TData = GetImagesQuery, TError = unknown>(
  ...
  options?: Omit<UseQueryOptions<GetImagesQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetImagesQuery, TError, TData>["queryKey"];
  }
) => {
  return useQuery<GetImagesQuery, TError, TData>({
    queryKey: ["GetImages", variables],
    queryFn: fetcher<GetImagesQuery, GetImagesQueryVariables>(
      GetImagesDocument
    ).bind(null),
    ...options,
  });
